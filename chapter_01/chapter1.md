...
### 3.4 毛细管-回气管设计和选型
&emsp;&emsp;毛细管本身不具备大幅优化稳态系统工况的能力，调节毛细管的流量参数会导致冷凝侧的过冷度和蒸发器侧过热度发生变化，造成系统的制冷剂灌注量需要重新匹配。在蒸发器满液时，影响吸气流量的主要因素是蒸发压力，也就是蒸发温度，而蒸发温度的高低是由间室空气温度和蒸发器的总热阻决定的，和毛细管流量关系不大，想通过增大毛细管流量来提高蒸发温度，仅在蒸发器严重过热时成立。
